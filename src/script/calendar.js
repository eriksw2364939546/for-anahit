var Calendar = function (t) {
	this.divId = t.RenderID ? t.RenderID : '[data-render="calendar"]', this.DaysOfWeek = t.DaysOfWeek ? t.DaysOfWeek : ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"], this.Months = t.Months ? t.Months : ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
	var e = new Date;
...
Calendar.prototype.nextMonth = function () {
	...
	var r = (new Date).getDate(),
		...
		o = new Date(t, e, 1).getDay() - 1; // <------ Изменение здесь
	if (o === -1) o = 6; // <------ Изменение здесь
	var i = new Date(t, e + 1, 0).getDate(),
		u = 0 == e ? new Date(t - 1, 11, 0).getDate() : new Date(t, e, 0).getDate(),
		s = "<span>" + this.Months[e] + " &nbsp; " + t + "</span>",
		d = '<div class="table">';
	d += '<div class="row head">';

	var daysOfWeek = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]; // <---- Изменение здесь
	for (var c = 0; c < 7; c++) d += '<div class="cell">' + daysOfWeek[c] + "</div>";
